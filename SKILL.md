...
description: 创建 uni-app + Vue 3 + TypeScript 项目模版，从 Gitee 拉取模版代码并初始化项目，自动配置开发规范。使用方式：/le-uniapp-skill <项目名称>
argument-hint: <项目名称>
...
使用此模版创建的项目，请遵循以下规范。这些规范已写入项目的 `CLAUDE.md` 中，Claude 在后续开发中会自动遵循。
